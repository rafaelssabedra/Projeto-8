...
def coleta_dados(api_tce, variavel):
    """ realiza a análise dos dados referentes a variável escolhida no data-frame do Balancete """
...
def media_desv(dados):
    """ essa função calcula a média e o desvio-padrão da variável financeira dos dados escolhidos """
